#!/usr/bin/env bash
# =============================================================
# w01_linux_essential — submit.sh
# Validates results then pushes to GitHub
# =============================================================

LOG="results/results.log"
REQUIRED=("task1" "task2" "task3" "task4" "task5" "task6" "task7" "task8" "task9" "task10" "task11" "task12")
TOTAL=${#REQUIRED[@]}
...
echo "=============================================="
echo "  w01_linux_essential — Submit"
echo "=============================================="
echo ""
...
if git diff --cached --quiet; then
  ...
  git commit -m "w01_linux_essential submission — Score: ${PASS_COUNT}/${TOTAL} — ${TIMESTAMP}"
